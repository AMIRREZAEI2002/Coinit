...
const rows: CryptoRow[] = [
  {
    ...
    orderMargin: '$3,400.00',
    availableMargin: '$27,400.00',
  },
  {
    id: 2,
    name: 'BTC',
    ...
    orderMargin: '$1,200.00',
    availableMargin: '$15,300.00',
  },
  {
    id: 3,
    name: 'ETH',
            ...
            <AssetCard key={asset.id}>
              ...
              >
                ...
                <Box>
                  ...
                  <Typography>{asset.positionMargin}</Typography>
                </Box>
                <Box>
                  <Typography variant="caption" color="text.secondary">
                    Order Margin
                  </Typography>
                  <Typography>{asset.orderMargin}</Typography>
                </Box>
                <Box>
                  <Typography variant="caption" color="text.secondary">
                    Available Margin
                  </Typography>
                  <Typography fontWeight={600}>{asset.availableMargin}</Typography>
                </Box>
              </Box>
